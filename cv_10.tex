...
\header{dr. philipp}{bayer}{plant bioinformatician} % Your name and current job title/field
...
\item Interact and manage with the community of 5000 users
\item System administration of the site's servers
\end{itemize}}
...
{University teaching}
{UWA, Perth}
{Co-taught and co-supervised SCIE4002, computational analysis for biology and biomedical MSc students. Set up the computational infrastructure needed for practicals.}
%------------------------------------------------
\entry
{2016}
{Teaching Software Carpentry}
{Research Bazaar, Murdoch University, Perth}
{Taught an introduction to Python}
%------------------------------------------------
\entry
{2016}
{Software Carpentry}
...
\cite{lee2016genome}
- Supervised part of the analysis,
