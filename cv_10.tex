...
{UWA, Perth}
{ResBaz is a world-wide three-day festival promoting digital literacy. As member of the organising committee I searched for helpers and teachers, drafted the timeplan, designed the web page, and raised funding.}
%------------------------------------------------
\end{entrylist}
\begin{entrylist}
\entry
...
{UWA}
{Three year fellowship to pursue research at UWA.}
%------------------------------------------------
\entry
{2017}
