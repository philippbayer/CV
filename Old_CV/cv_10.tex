...
{DECRA Fellow}
{UWA, Perth}
{My first step towards an independent lab with funding for the first PhD-student primarily supervised by me and with \$448,781 in government and \$418,772 UWA funding. I am modeling mechanisms of gene loss and birth in crops to learn where new genes come from, and how to avoid loss of agronomically important genes.}
\entry
{2017--2020}
{Forrest Fellow}
{UWA, Perth}
...
\cite{varshney2021fast}
\cite{marsh2021haplotype}
\cite{danilevicz2021maize}
\cite{gacek2021qtl}
\cite{ramsay2021genomic}
\cite{bayer2021sequencing}
\cite{danilevicz2021resources}
\cite{ewere2021marine}
\cite{rijzaani2021pangenome}
\cite{bayer2021application}
\cite{vranken2021genotype}
\cite{bayer2021modelling}
\cite{hu2021amborella}
\cite{yuan2021current}
\cite{yang2021candidate}
\cite{li2021assembly}
\cite{valliyodan2021genetic}
\cite{danilevicz2021high}
\cite{yang2020genome}
\cite{bayer2021machine}
...
\cite{tahghighi2019genetic}
\cite{scheben2019cropsnpdb}
\cite{anderson2019genome}
...
\cite{appels2018shifting}
\cite{ramirez2018transcriptional}
\cite{lee2018genomic}
\cite{mousavi2018exploring}
\cite{hurgobin2018homoeologous}
\cite{schneider2019establishing}
...
\entry
{2021--2023}
{Grant: ARC Discovery Early Career Research Award}
{UWA}
{Awarded DECRA for 2021-2023. Total funding: \$448,781 and \$418,772 in UWA funding.}
%------------------------------------------------
\entry
{2020--2022}
{Grant: Identifying genetic contributors to canola blackleg resistance in the presence of environmental effects using Machine Learning}
{GRDC}
{With Prof. Dave Edwards, Prof. Mohammed Bennamoun, Dr. Farid Boussaid, Prof. Jacqueline Batley. Total funding: \$309,524.}
%------------------------------------------------
\entry
{2020--2022}
{Grant: Machine Learning - Project E: Deep Learning for early detection and classification of crop disease and stress}
{GRDC}
{With Prof. Mohammed Bennamoun, Dr. Farid Boussaid, Prof. Dave Edwards, Dr. Nic Taylor. Total funding: \$344,971.}
%------------------------------------------------
\entry
{2019}
...
\entry
{2021}
{Introduction to tidyverse and purrr}
{ASI R Workshop, University of Western Australia, Perth}
{Introducing RStudio, project organisation, basic tidyverse, loops, functions, maps}
\entry
{2019}
...
\entry
{2021}
{Machine learning in bioinformatics – where are we and what’s next?}
{Invited talk}
{Curtin University, CCDM}
\entry
{2021}
{Machine learning in plant breeding and bioinformatics}
{Invited talk}
{CINVESTAV, online}
\entry
{2021}
